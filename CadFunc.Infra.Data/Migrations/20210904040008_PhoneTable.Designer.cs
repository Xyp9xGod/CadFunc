...
namespace CadFunc.Infra.Data.Migrations
{
    ...
    [Migration("20210904040008_PhoneTable")]
    partial class PhoneTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CadFunc.Domain.Entities.Phone", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CadFunc.Infra.Data.Identity.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("CadFunc.Domain.Entities.Phone", b =>
                {
                    b.HasOne("CadFunc.Domain.Entities.Employee", "Employee")
                        .WithMany("Phones")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CadFunc.Infra.Data.Identity.ApplicationUser", null)
                        .WithMany()
